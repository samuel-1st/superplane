...
<CardGrid>
  ...
  <LinkCard title="Get Workflow Usage" href="#get-workflow-usage" description="Retrieve billable GitHub Actions usage for the organization" />
...
This component requires the GitHub App to have **Organization permission: Organization administration (read)**.

**Important**: Existing installations will need to approve the new permission when prompted by GitHub. Until the permission is granted, this component will return a 403 error.
...
- Usage can be filtered by specific repositories or retrieved organization-wide
...
```json
{
  "data": {
    ...
    "minutes_used_breakdown": {
      "Actions Linux": 1200.0,
      "Actions Windows": 400.5,
      "Actions macOS": 240.0
    },
    "included_minutes": 0,
    "total_paid_minutes_used": 150.0
  },
